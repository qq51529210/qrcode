...
var (
	...
	numericTable             = [256]byte{} // 用于快速判断模式
	alphanumericTable        = [256]byte{} // 用于快速判断模式
	levelModeVersionCapacity = [maxLevel][maxMode][maxVersion]int{
		{
			{
	...
	versionErrorCorrectionTable = [maxVersion][maxLevel]*errorCorrectionTable{
		{
...
type errorCorrectionTable struct {
